...
array_one_dimension: ID COLON ARRAY CORCHETE_LEFT (NUMBERS | variable_item) DOBLEDOTS (NUMBERS | variable_item) CORCHETE_RIGHT OF array_type SEMI_COLON;

array_two_dimension: ID COLON ARRAY CORCHETE_LEFT (NUMBERS | variable_item) DOBLEDOTS (NUMBERS | variable_item) CORCHETE_RIGHT CORCHETE_LEFT (NUMBERS | variable_item) DOBLEDOTS (NUMBERS | variable_item) CORCHETE_RIGHT OF array_type SEMI_COLON;
